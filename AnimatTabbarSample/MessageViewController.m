...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(indexPath.section==0){
        ...
        if (indexPath.row == 0){
            ...
            GradeController *gradeController = [self.storyboard instantiateViewControllerWithIdentifier:@"GradeController"];
            [self.navigationController pushViewController:gradeController animated:YES];
        }
        
    }
    else if(indexPath.section==2){
        ComplainViewController *complainViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"ComplainViewController"];
