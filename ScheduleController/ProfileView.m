...
-(CGFloat)getWidth:(NSString*)text{
    ...
    CGSize labelsize = [text boundingRectWithSize:self.content.frame.size options:NSStringDrawingUsesLineFragmentOrigin attributes:attribute context:nil].size;
